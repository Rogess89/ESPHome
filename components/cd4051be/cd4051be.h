...
class CD4051BEComponent : public Component {
 public:
  ...
  /// set the pin connected to multiplexer control pin c
...
class CD4051BESensor : public sensor::Sensor, public PollingComponent, public voltage_sampler::VoltageSampler {
 public:
  CD4051BESensor(CD4051BEComponent *parent);
